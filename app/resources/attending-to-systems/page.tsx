    ...
    <>
      <div className="page-hero">
        ...
        <div className="page-hero-inner">
          ...
          <h1>Attending to the systems of<br /><em>people, processes, and technology</em></h1>
      ...
      <section style={{ background: 'var(--cream)' }}>
        <div style={{ maxWidth: 740, margin: '0 auto' }}>
          ...
          <div style={{ background: 'rgba(41,63,148,0.05)', border: '1px solid rgba(41,63,148,0.15)', borderRadius: 4, padding: '24px 28px', marginBottom: 40 }}>
            ...
            <a href="https://reospartners.com/blog/systems-thinking-practical-approaches" target="_blank" rel="noopener noreferrer" style={{ fontSize: '15px', color: 'var(--brand)', textDecoration: 'none', borderBottom: '1px solid rgba(41,63,148,0.3)', paddingBottom: 2 }}>
              Systems Thinking: Practical Approaches at reospartners.com
            </a>
          </div>
