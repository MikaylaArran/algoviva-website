...
const resources = [
  ...
  { tag: 'Reflection', title: 'From Healthcare to Inclusive AI Innovation: Why I co-founded AlgoViva', desc: 'When I first heard about the launch of the world\'s first fully AI-powered hospital, I imagined what it could mean for Africa\'s healthcare challenges.', footer: 'Nonhlanhla Akpan · 9 November 2025', href: '/resources/from-healthcare-to-ai' },
  { tag: 'Reflection', title: 'From Design to Data', desc: 'I believe technology should not only mirror the world but help shape it for the better. At AlgoViva, I work to make AI a true creative partner that amplifies diverse voices.', footer: 'Mikayla Arran · 9 November 2025', href: '/resources/from-design-to-data' },
  { tag: 'Systems thinking', title: 'Attending to the systems of people, processes, and technology', desc: 'Building ethical AI starts with understanding AI as a system of people, processes, and technology. This piece explores how systems thinking can guide responsible AI governance and lasting change.', footer: 'Akanimo Akpan · 2 November 2025', href: 'https://reospartners.com/blog/systems-thinking-practical-approaches' },
  { tag: 'Systems thinking', title: 'Towards a national interoperable data platform: The social side of innovation', desc: 'Ethical transformation requires more than advanced technology. It demands collaboration, dialogue, and shared purpose.', footer: 'Akanimo Akpan · 2 November 2025', href: '/resources/national-data-platform' },
  { tag: 'Leadership', title: 'Beyond the Algorithm: What true leadership requires in the age of AI', desc: 'True leadership in the age of AI means moving beyond efficiency and automation to embrace values that connect people, purpose, and technology.', footer: 'Akanimo Akpan · 29 August 2025', href: '/resources/beyond-the-algorithm' },
