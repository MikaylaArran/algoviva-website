...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    setLoading(true)
    // Replace this with your form handler (Formspree, Resend, etc.)
    // For now it simulates a submission
      ...
      <section style={{ background: 'var(--cream)' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'start' }} className="about-grid">
          ...
          <div>
            ...
            {sent ? (
              <div style={{
                ...
                <div style={{ fontFamily: 'var(--serif)', fontSize: 22, color: 'var(--teal)', marginBottom: 10 }}>Message received.</div>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                    ...
                    <input name="org" value={form.org} onChange={handleChange} style={inputStyle} placeholder="Company / organisation" />
                  </div>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  <label style={labelStyle}>Email address *</label>
                  <input name="email" type="email" required value={form.email} onChange={handleChange} style={inputStyle} placeholder="you@organisation.com" />
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            >
              <div style={{ ...contactIconStyle, background: 'rgba(37,211,102,0.12)', color: '#25D366' }}>
              ...
              <div>
                ...
                <div style={contactValueStyle}>+27 64 048 4228</div>
                <div style={contactHintStyle}>Chat with us on WhatsApp</div>
              </div>
            </a>

            {/* Phone */}
            <a href="tel:+27640484228" style={contactCardStyle}>
              <div style={contactIconStyle}>✆</div>
              <div>
                <div style={contactLabelStyle}>Phone</div>
                <div style={contactValueStyle}>+27 64 048 4228</div>
                <div style={contactHintStyle}>Monday – Friday, 8am – 5pm SAST</div>
              </div>
            </a>

            {/* Location */}
            <div style={{ ...contactCardStyle, cursor: 'default', textDecoration: 'none' } as React.CSSProperties}>
              <div style={contactIconStyle}>◎</div>
              <div>
                <div style={contactLabelStyle}>Location</div>
                <div style={contactValueStyle}>Johannesburg, South Africa</div>
                <div style={contactHintStyle}>We work across the continent</div>
              </div>
            </div>
          </div>
        </div>
